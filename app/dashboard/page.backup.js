...
export default function Dashboard() {
    ...
    const cards = [
        ...
        // Metrics Cards
        { type: 'room_utilization', title: 'อัตราใช้ห้อง', count: metrics.roomUtilization?.percentage || 0, unit: '%', gradient: 'from-cyan-600 to-blue-500', icon: BarChart3 },
        { type: 'teaching_load', title: 'ภาระงานครูเฉลี่ย', count: metrics.teachingLoad?.average || 0, unit: 'ชม./คน', gradient: 'from-violet-600 to-purple-500', icon: Activity },
    ];
